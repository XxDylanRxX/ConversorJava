...
public class Interfaces {
	...
	public void Seleccion() {
		int opcion = JOptionPane.showConfirmDialog(null, "¿Quieres continuar?", "Confirmación",
		...
		if (opcion == JOptionPane.YES_OPTION) {
			...
			case "Conversión de monedas":
				String opciones = (JOptionPane
						.showInputDialog(null, "Elije la moneda a la que deseas convertir tu dinero ", "Monedas",
								JOptionPane.PLAIN_MESSAGE, null, new Object[] { "Dolar A Córdobas",
										"Córdobas A Dolares", "Euros A Códobas", "Córdobas A Euros" },
								"Seleccion"))
						.toString();
			...
			case "Conversión de Temperatura":
				...
				String opciones1 = (JOptionPane.showInputDialog(null, "Elije medida a la que deseas convertir",
						"Monedas", JOptionPane.PLAIN_MESSAGE, null, new Object[] { "Celsius a fahrenheit",
